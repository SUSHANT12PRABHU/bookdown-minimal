...
```{r, fig.width=5, fig.height=5, fig.cap = "The most common words in Darwin's novel", echo=TRUE}
library(RColorBrewer) # color palettes
library(wordcloud) # word-cloud generator

darwin_wordcloud <- darwin_data %>%
  count(word) %>%
...
```{r, fig.width=5, fig.height=5, fig.cap = "Afinn Words that contribute to positive and negative sentiment in Darwin's Novel", echo=TRUE}
...
```{r, fig.width=5, fig.height=5, fig.cap = "Bing Words that contribute to positive and negative sentiment in Darwin's Novel", echo=TRUE}
library(reshape2)
...
```{r, fig.width=7, fig.height=5, fig.cap = "NRC Words that contribute to categorical sentiment in Darwin's Novel", echo=TRUE}
nrc_plot <- darwin_nrc %>%
  group_by(sentiment) %>%
